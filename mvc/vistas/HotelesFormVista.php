                    ...
                    <section>
                        <div class="container">
                            <div class="row">
                                ...
                                <br>
                                <p>Código póstal: <input type ="text" name="cp" placeholder= "Código postal del hotel"></p>
                                <br>
                                <p>País: <input type ="text" name="nombre" placeholder= "Páis"></p>
                                <br>
                                <p>Nº de estrellas: <input type ="number" name="estrellas" placeholder= "Nº de estrellas"></p>
                                <br>
                                <p>imagen del hotel: <input type ="file" name="imagen"></p>
